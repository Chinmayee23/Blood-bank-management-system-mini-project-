...
<div class="navbar-fixed">
  ...
  <div class="container">
    ...
    <form class="col s12" action="regdoncamp.php" method="post">
	         <div class="row">
			 <br/>
			 <br/>
			  <?php
	...
	{	
			...
			if($email_query_run=mysqli_query($connect,$email_query))
			{
				...
				<div class="alert alert-warning" role="alert">
					...
					$signup_query = "INSERT INTO `users` (`username`,`useremail`,`userphone`,`useraddress`,`userpwd`,`usertype`) VALUES ('$name','$email','$phone','$address','$pwd','donation camp')";
					...
					else
					{
						?>
					<div class="alert alert-warning" role="alert">
							You have been registered.</div><?php
					...
					$q1="INSERT INTO `blood`(`id`,`blgroup`) VALUES('$uid','O+ve')";
					$q2="INSERT INTO `blood`(`id`,`blgroup`) VALUES('$uid','O-ve')";
					$q3="INSERT INTO `blood`(`id`,`blgroup`) VALUES('$uid','B+ve')";
					$q4="INSERT INTO `blood`(`id`,`blgroup`) VALUES('$uid','B-ve')";
					$q5="INSERT INTO `blood`(`id`,`blgroup`) VALUES('$uid','A+ve')";
					$q6="INSERT INTO `blood`(`id`,`blgroup`) VALUES('$uid','A-ve')";
					$q7="INSERT INTO `blood`(`id`,`blgroup`) VALUES('$uid','AB+ve')";
					$q8="INSERT INTO `blood`(`id`,`blgroup`) VALUES('$uid','AB-ve')";
					header('Location:logindon.php');
					//Not be written
					//echo 'session set';
					
					/*
					if(isset ($_SESSION['id'])&& !empty($_SESSION['name']) && isset ($_SESSION['email'])&&mysqli_query($connect,$q1)&&mysqli_query($connect,$q2)&&mysqli_query($connect,$q3)&&mysqli_query($connect,$q4)&&mysqli_query($connect,$q5)&&mysqli_query($connect,$q6)&&mysqli_query($connect,$q7)&&mysqli_query($connect,$q8))
					{
...
?>
        ...
        <div class="input-field col s6">
          ...
          <label for="name">Donation camp name</label>
        </div>
		</div>
