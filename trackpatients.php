  ...
  <nav class="#ed0004" role="navigation">
    <div class="nav-wrapper container">
      ...
      <ul class="right  hide-on-med-and-down">
		...
		<li><a href="trackeventsh.php">Track events </a></li>
		<li><a href="trackbloodh.php">Track blood </a></li>
...
<div class="container">
 <div class="card mb-4 wow fadeIn">
				...
				session_start();
				$req_id=$_SESSION['id'];
				$query="SELECT * FROM `patients` where `hid`=$req_id";
				if($query_run=mysqli_query($connect,$query))
							{
								...
								else
								{
									while($row = mysqli_fetch_assoc($query_run)) 
									{
										...
										$contact=$row['contact'];
										$blg=$row['blood_group'];
										$blrequired=$row['blrequired'];
										$blreceived=$row['blreceived'];
										$disease=$row['disease'];
										$hid=$row['hid'];
										$pid=$row['pid'];
										...
										echo "Name ".$name."<br>";
										echo "Emergency contact: ".$contact."<br>";
										echo "Disease: ".$disease."<br>";
										echo "Blood group: ".$blg."<br>";
										
										
										echo "Amount of blood required: ".$blrequired."<br>";
										echo "Amount of blood received: ".$blreceived."<br>";
										
										echo '<form  action="hub.php?C=6&ID='.$pid.'" method="post">
										Update amount of blood required(in ml):
						...
						<input type="submit" name="save" class="btn red btn-block my-4" style="width:20%;" value="Add" "/></form>
										...
										';
										echo '<form  action="hub.php?C=7&ID='.$pid.'" method="post">
										Update amount of blood received(in ml):
					              <input id="email" name="add"type="number" class="validate" required>
