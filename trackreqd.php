...
<div class="navbar-fixed">
  ...
  <nav class="#ed0004" role="navigation">
    <div class="nav-wrapper container">
      ...
      <li><a href="trackeventsd.php">Track donation camp events </a></li>
 ...
 <?php
                ...
                $query="SELECT * FROM `requests` where `blrequired`>0 and `blood_group`='$blood_group'";
                if($query_run=mysqli_query($connect,$query))
                            {
                                ...
                                else
                                {
                                    while($row = mysqli_fetch_assoc($query_run)) 
                                    {
                                        ...
                                        echo '<form  action="hub.php?C=5&ID='.$rid.'" method="post">
